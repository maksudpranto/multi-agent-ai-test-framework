...
// Dedicated Projects page — the working list where you create, open, rename and
// delete projects. (Home stays the story/overview; this is the doing page.)
    ...
    <div className="content dash">
      <div className="projects-page-head">
        <div>
          <h1>Projects</h1>
          <p className="muted">
            Each project holds requirements. Open one to let the AI team build and
            prove a test suite.
          </p>
        </div>
